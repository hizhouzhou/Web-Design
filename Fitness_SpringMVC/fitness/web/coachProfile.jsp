<%-- 
    Document   : coachProfile
    Created on : 2019-4-18, 17:45:59
    Author     : zhouzhou
--%>
    ...
    <div class="container desc">
        ...
        <form action="profile2.htm">
          ...
          <!-- height -->
            <div class="col-lg-12 "> 
              <p>
                <label>  Height:  </label>  ${sessionScope.Coach.height}
              </p>
            </div>
              <!-- Weight -->
              <div class="col-lg-12 ">
                <p>
                        <label> Weight: </label>   ${sessionScope.Coach.weight}
                </p>
              </div>
               <!-- Age -->
            <div class="col-lg-12 ">
              <p>
                <label>  Age:   </label>   ${sessionScope.Coach.age}
              </p>
            </div>
                <!-- Gender -->
            <div class="col-lg-12 ">
              <p>
                <label>  Gender:   </label>  ${sessionScope.Coach.gender}
              </p>
            </div>
