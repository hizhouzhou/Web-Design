<%-- 
    Document   : coachMoreVideos
    Created on : 2019-4-22, 2:23:01
    Author     : zhouzhou
--%>
...
<html>
  ...
  <a class="nav-link" href="mycourse.htm" > <i class="fab fa-discourse"></i> My courses</a>
        ...
        <li class="nav-item">
           ...
           <!-- view all videos -->
        <li class="nav-item">
            <a class="nav-link" href="moreVideos.htm?role=coach" > <i class="fab fa-youtube"></i> More videos<span class="sr-only">(current)</span></a>
          </li>
