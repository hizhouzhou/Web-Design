<%-- 
    Document   : edit2Profile
    Created on : 2019-4-18, 17:55:47
    Author     : zhouzhou
--%>
...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <!-- profile page -->
      <li class="nav-item">
        <a class="nav-link" href="coachProfile.jsp"><i class="far fa-id-card"></i> Profile<span class="sr-only">(current)</span></a>
      </li>
  ...
  <a class="nav-link" href="mycourse.htm" > <i class="fab fa-discourse"></i> My courses</a>
    ...
    <div class='container'>
    <!-- row -->
    <form:form commandName="coachprofile"  method="post" action="profile2.htm">
        
        <div class="form-row">
             <!--userID->
-->            <div class="form-group">
                 <label for="coachID" class="col-lg-6 control-label">Coach ID: </label>
                  <form:input class="form-control col-lg-6" path="coachID" type="text" value=" ${sessionScope.Coach.getCoachID()}" readonly="true"/>
            </div>
       
             <!--userName-->
            <div class="form-group">
                 <label for="userName" class="col-lg-6 control-label">Coach Name: </label>
                  <form:input class="form-control col-lg-6" path="userName" type="text" value=" ${sessionScope.Coach.getUserName()}" readonly="true"/>
            </div>
        </div>
           ...
           <div class="form-row">
            ...
            <div class="form-group">
               <label  class="col-lg-6 control-label">Your Height(cm): </label>
                  <form:input class="form-control col-lg-6" path="height" type="text" value=" ${sessionScope.Coach.getHeight()}" pattern="$*[0-9]+([.]{1}[0-9]+){0,1}$|^$" />
            </div>
            </div> 
            ...
            <div class="form-group">
                 <label  class="col-lg-6 control-label">Your Weight(kg): </label>
                  <form:input class="form-control col-lg-6" path="weight" type="text" value="${sessionScope.Coach.getWeight()}" pattern="$*[0-9]+([.]{1}[0-9]+){0,1}$|^$"  />
            </div>
             </div>
            ...
            <div class="form-group">
                 <label for=" Age" class="col-lg-6 control-label">Age: </label>
                  <form:input class="col-lg-6 form-control" path="age" type="text" value="${sessionScope.Coach.getAge()}" pattern="[0-9]+" />
            </div>
             ...
             <!--Gender-->
            <div class="form-group">
                 <label for=" Gender" class="col-lg-15 control-label">Gender: (${sessionScope.Coach.getGender()} now)</label> 
              <br/>
