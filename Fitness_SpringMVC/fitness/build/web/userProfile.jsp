    ...
    <div class="container desc">
        ...
        <form action="profile.htm">
          ...
          <!-- height -->
            <div class="col-lg-12 "> 
              <p>
                <label>  Height:  </label>  ${sessionScope.User.height}
              </p>
            </div>
              <!-- Weight -->
              <div class="col-lg-12 ">
                <p>
                        <label> Weight: </label>   ${sessionScope.User.weight}
                </p>
              </div>
               <!-- Age -->
            <div class="col-lg-12 ">
              <p>
                <label>  Age:   </label>   ${sessionScope.User.age}
              </p>
            </div>
                <!-- Gender -->
            <div class="col-lg-12 ">
              <p>
                <label>  Gender:   </label>  ${sessionScope.User.gender}
              </p>
            </div>
